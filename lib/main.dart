...
import 'package:places_guide/auth/login_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        UserResturants.routeName: (ctx) => UserResturants(),
        UserGovernment.routeName: (ctx) => UserGovernment(),
         UserUniversity.routeName: (ctx) => UserUniversity(),
      },
    );
  }
}
